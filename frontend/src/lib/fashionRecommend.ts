...
const CATEGORY_RULES: { category: FashionCategory; keywords: string[] }[] = [
  ...
  // 브랜드명은 TOP·BOTTOM·OUTER 규칙이 먼저 걸러진 뒤에만 닿는다. "나이키 후드" 는 TOP 으로 가고
  // 품목어가 없는 "나이키 에어맥스 270" 만 여기로 떨어진다.
  { category: 'SHOES', keywords: ['스니커즈', '운동화', '신발', '부츠', '로퍼', '슈즈', '뉴발란스', '컨버스', '척테일러', '닥터마틴', '반스', '아디다스', '나이키', '에어맥스'] },
