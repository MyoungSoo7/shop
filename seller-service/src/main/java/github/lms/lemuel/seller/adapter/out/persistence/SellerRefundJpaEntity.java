...
/** {@code seller_refunds} 매핑. 결제 행과 FK 로 묶지 않는 이유는 V1 마이그레이션 주석 참조. */
@Entity
@Table(name = "seller_refunds")
@IdClass(SellerRefundId.class)
class SellerRefundJpaEntity {
    ...
    protected SellerRefundJpaEntity() {
    }
}
