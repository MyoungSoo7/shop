...
public class MenuCreateRequest {
    ...
    @Schema(description = "상단 네비용 짧은 이름 (없으면 name 사용)", example = "사용자")
    ...
    @Schema(description = "부제 — 사이드바 항목 아래 한 줄 설명", example = "회원 조회 · 정지")
    ...
    @Schema(description = "노드 종류 (미지정 시 ITEM)", example = "ITEM")
    ...
    @Schema(description = "접근 허용 역할 CSV (null 이면 제한 없음)", example = "ADMIN,MANAGER")
